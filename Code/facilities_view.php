...
<form name="form1" method="post" action="">
  <table width="1597" border="0" align="center">
    <tr>
      ...
      <th width="118"><span class="style3 style2"><strong>Edit</strong></span></th>
      <th width="100"><span class="style6">delete</span></th>
    </tr>
	<?php
	...
	<tr>
	  ...
	  <td><a href="facilities_edit.php?Facility_id=<?php echo $row['Facility_id'];?>">Edit</a></a></td>
	  <td><a href="facilities_delete.php?Facility_id=<?php echo $row['Facility_id'];?>">delete</a></td>
    </tr>
    </tr>
	<?php
	}
