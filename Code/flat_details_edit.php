...
<form action="flat_details_edit1.php" id="formID" method="post" name="form1">
  <table width="683" height="395" border="0" align="center">
    ...
    <tr>
      ...
      <td><input name="flat_description" type="text" id="flat_description" value="<?php echo $row['Flat_description'];?>"class="validate[required,custom[onlyLetter]"></td>
    </tr>
    <tr>
      <td>Flat photo </td>
      <td><input name="flat_photo" type="file" id="flat_photo"class="validate[required]"></td>
    </tr>
    <tr>
      <td>Flat type </td>
