...
<form name="form1" method="post" id="formID" action="Expenditure_insert.php">
  <table width="491" border="0" align="center">
    <tr>
      ...
      <td width="245"><input name="expenditure_title" type="text" id="expenditure_title"class="validate form-control[required,custom[onlyLetter]"></td>
    </tr>
    <tr>
      <td height="56">Expenditure description </td>
      <td><input name="expenditure_desc" type="text" id="expenditure_desc"class="validate form-control[required,custom[onlyLetter]"></td>
    </tr>
    <tr>
      <td height="56">Expenditure amount </td>
      <td><input name="expenditure_amount" type="text" id="expenditure_amount"class="validate form-control[required,custom[onlyNumber]"></td>
    </tr>
    <tr>
