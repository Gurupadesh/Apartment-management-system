...
<body>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                             Owner Facilities Pending Charges 
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                              Owner Facilities Pending Charges </div>
	...
	$sql="select * from owner_facilities_charges fc,flat_owner_details fd where fc.Flat_owner_id=fd.Flat_owner_id and fc.Month='$month' and fc.Year='$year' and fc.Status='Pending'";
	$sl_no=1;
	...
	<tr>
      ...
      <td><a href="owner_facilites_charges_edit.php?Owner_facilities_charges_id=<?php echo $row['Owner_facilities_charges_id'];?>" class="btn btn-primary">Edit</a></td>
