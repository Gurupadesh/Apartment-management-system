...
<body>
    ...
    <tr>
	  ...
	  <th width="104"><span class="style2">Allot</span></th>
	...
	<tr>
      ...
      <td><?php if($row['allot_status']=='Allot Pending') {  ?><a href="vehicle_slot_details_form.php?Owner_vehicle_id=<?php echo $row['Owner_vehicle_id'];?>" class="btn btn-primary">Allot</a><?php } ?></td>
	  <td><a href="owner_vehicle_details_edit.php?Owner_vehicle_id=<?php echo $row['Owner_vehicle_id'];?>" ><img src="img/EDIT.png" width="30" height="30"</a></a></td>
      <td><a href="owner_vehicle_details_delete.php?Owner_vehicle_id=<?php echo $row['Owner_vehicle_id'];?>" ><img src="img/delete.png" width="30" height="30"</a></td>
	</tr>
	<?php
	}
	?>
