...
<body>
   ...
   <tr>
	...
	<tr>
	  ...
	  <td><div align="center"><a href="Event_details_edit.php?Event_id=<?php echo $row['Event_id'];?>"><img src="img/EDIT.png" width="30" height="30"</a></div></td>
	  <td><div align="center"><a href="Event_details_delete.php?Event_id=<?php echo $row['Event_id'];?>"><img src="img/delete.png" width="30" height="30"</a></div></td>
    </tr>
	  <?php
	}
	?>
