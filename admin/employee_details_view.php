...
<body>
  ...
  <!--/. NAV TOP  -->
	...
	<tr>
      ...
      <td><a href="employee_details_edit.php?Employee_id=<?php echo $row['Employee_id'];?>"><img src="img/EDIT.png" width="30" height="30"</a></td>
      <td><a href="employee_details_delete.php?Employee_id=<?php echo $row['Employee_id'];?>"><img src="img/delete.png" width="30" height="30"</a></td>
	</tr>
	<?php
	}
	?>
